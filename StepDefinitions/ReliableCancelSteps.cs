...
{
    [Binding]
    [Scope(Tag = "ReliableCancel")]
    public class ReliableCancelSteps
    {
        private RestResponse? _response;  
        private string _apiEndpoint;   
        private string _payload;   

        public ReliableCancelSteps()
        {
            ...
            _apiEndpoint = configuration["ReliableCancelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in appsettings.json.");
        }
        ...
        [Given(@"The ReliableCancelEndpoint is loaded from ""(.*)""")]
        public void GivenTheApiEndpointIsLoadedFrom(string fileName)
        {
            ...
            _apiEndpoint = configuration["ReliableCancelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in " + fileName);
