...
{
    [Binding]
    [Scope(Tag = "ReliableManifest")]
    public class ReliableManifestSteps
    {
        private RestResponse? _response;  
        private string _apiEndpoint;   
        private string _payload;   

        public ReliableManifestSteps()
        {
            ...
            _apiEndpoint = configuration["ReliableManifestEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in appsettings.json.");
        }
        ...
        public void GivenTheApiEndpointIsLoadedFrom(string fileName)
        {
            ...
            _apiEndpoint = configuration["ReliableManifestEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in " + fileName);
