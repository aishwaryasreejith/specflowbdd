...
{
    [Binding]
    [Scope(Tag = "IntelcomLabel")]
    public class IntelcomLabelSteps
    {
        private RestResponse? _response;  
        private string _apiEndpoint;   
        private string _payload;   

        public IntelcomLabelSteps()
        {
            ...
            _apiEndpoint = configuration["IntelcomLabelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in appsettings.json.");
        }
        ...
        public void GivenTheApiEndpointIsLoadedFrom(string fileName)
        {
            ...
            _apiEndpoint = configuration["IntelcomLabelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in " + fileName);
