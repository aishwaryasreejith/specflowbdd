...
{
    [Binding]
    [Scope(Tag = "IntelcomManifest")]
    public class IntelcomManifestSteps
    {
        private RestResponse? _response;  
        private string _apiEndpoint;   
        private string _payload;   

        public IntelcomManifestSteps()
        {
            ...
            _apiEndpoint = configuration["IntelcomManifestEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in appsettings.json.");
        }
        ...
        [Given(@"The ReliableManifestEndpoint is loaded from ""(.*)""")]
        public void GivenTheApiEndpointIsLoadedFrom(string fileName)
        {
            ...
            _apiEndpoint = configuration["IntelcomManifestEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in " + fileName);
