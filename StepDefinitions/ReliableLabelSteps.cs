...
{
    [Binding]
    [Scope(Tag = "ReliableLabel")]
    public class ReliableLabelSteps
    {
        private RestResponse? _response;  
        private string _apiEndpoint;   
        private string _payload;   

        public ReliableLabelSteps()
        {
            ...
            _apiEndpoint = configuration["ReliableLabelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in appsettings.json.");
        }
        ...
        public void GivenTheApiEndpointIsLoadedFrom(string fileName)
        {
            ...
            _apiEndpoint = configuration["ReliableLabelEndpoint"] ?? throw new InvalidOperationException("API endpoint is not configured in " + fileName);
