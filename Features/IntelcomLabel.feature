@IntelcomLabel
Feature: Return Label for intelcom

  Scenario: ReturnLabel for Intelcom
    Given The request data from the 'IntelcomLabelPayload.json' file stored in the 'Payloads' folder
